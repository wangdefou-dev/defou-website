              ...
              >
                <div className="flex items-start gap-5">
                  <div className="flex items-center gap-4 shrink-0">
                    <span className="font-mono text-sm text-primary/70">{svc.num}</span>
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-baseline gap-3 mb-1">
                      <h3 className="text-lg font-semibold text-warm-white">{svc.title}</h3>
                      <span className="text-sm text-primary/80 italic hidden sm:inline">{svc.tagline}</span>
                    </div>
